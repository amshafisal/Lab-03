...
#Answer Ex3
i aesthetic provides color values using specification
...
#answer ex4
geom_violin(mapping =plastic_waste, data =plastic_waste,stat = "ydensity",position = "dodge")
...
#answer Ex5
positive relationship, they all handle plastice waste wrongly
...
#answer Ex7
ggplot(data=plastic_waste,mapping=aes(x = total_pop,color = continent, fill = continent, y = plastic_waste_per_cao))+geom_point()

ggplot(data= plastic_waste, mapping = aes(x = coasal_pop, color = continent, fill = continent, y = plastic_waste_per_cap))+ geom_point()
...
#other ANSWER Ex8
geom_smooth(make a good shape to eye in the presence of overpolting and help to see the curve data analyis is it another way) the coastal cities for plastic per capita and lowest population.
